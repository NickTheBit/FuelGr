...
class Pricedata(models.Model):
    ...
    gasstationid = models.ForeignKey(Gasstations, models.DO_NOTHING, db_column='gasStationID')  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'pricedata'
        unique_together = (('gasstationid', 'fueltypeid', 'fuelsubtypeid'),)
